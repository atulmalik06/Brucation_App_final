...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, LocationListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        log.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent l = new Intent(MapsActivity.this, Login.class);
                MapsActivity.this.startActivity(l);
            }
        });
        ...
        btSat = (Button) findViewById(R.id.btSatellite);
        btSat.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if (mMap.getMapType() == GoogleMap.MAP_TYPE_NORMAL) {
                    mMap.setMapType(GoogleMap.MAP_TYPE_SATELLITE);
                    btSat.setText("Normal Map");
                } else {
                    mMap.setMapType(GoogleMap.MAP_TYPE_NORMAL);
                    btSat.setText("Satellite Map");
                }

            }
        });

        btTerrain = (Button) findViewById(R.id.btRoadMap);
        btTerrain.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if (mMap.getMapType() == GoogleMap.MAP_TYPE_NORMAL) {
                    mMap.setMapType(GoogleMap.MAP_TYPE_TERRAIN);
                    btTerrain.setText("Normal Map");
                } else {
                    mMap.setMapType(GoogleMap.MAP_TYPE_NORMAL);
                    btTerrain.setText("Terrain Map");
                }
            }
        });

        btHybrid = (Button) findViewById(R.id.btHybrid);
        btHybrid.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if (mMap.getMapType() == GoogleMap.MAP_TYPE_NORMAL) {
                    mMap.setMapType(GoogleMap.MAP_TYPE_HYBRID);
                    btHybrid.setText("Normal Map");
                } else {
                    mMap.setMapType(GoogleMap.MAP_TYPE_NORMAL);
                    btHybrid.setText("Hybrid Map");
                }
            }
        });
    ...
    public void onMapReady(GoogleMap googleMap) {
       ...
       /* googleMap.setOnInfoWindowClickListener(new GoogleMap.OnInfoWindowClickListener() {
            ...
            @Override
            public void onInfoWindowClick(Marker St_Johns) {
...
// Get back the mutable Polygon
        ...
        mMap.setOnInfoWindowClickListener(new GoogleMap.OnInfoWindowClickListener() {
            @Override
            public void onInfoWindowClick(Marker St_Johns) {
                Intent intent = new Intent(MapsActivity.this, Tictactoe.class);
                String title = St_Johns.getTitle();
                intent.putExtra("St_Johns", title);
                startActivity(intent);
            }
        });
        ...
        Marker Russel = mMap.addMarker(new MarkerOptions().position(new LatLng(51.531908, -0.468371)).title("Russell Building").snippet("Part of the Brunel Science Park").snippet("Named in memory of Peter Russell"));
        Marker Elliot = mMap.addMarker(new MarkerOptions().position(new LatLng(51.531868, -0.467499)).title("Elliot Jaques").snippet("Part of the Brunel Science Park").snippet("Named in memory of Elliot Jaques"));
        Marker Gardiner = mMap.addMarker(new MarkerOptions().position(new LatLng(51.531470, -0.468052)).title("Gardiner").snippet("Part of the Brunel Science Park").snippet("Named in memory of John  Gardiner"));
        Marker Metal = mMap.addMarker(new MarkerOptions().position(new LatLng(51.531448, -0.466968)).title("Advanced Metal Casting Centre").snippet("Part of the Brunel Science Park").snippet("Exists to turns Brunel's scientific breakthroughs into real life techniques"));
        ...
        Marker Kilmorey = mMap.addMarker(new MarkerOptions().position(new LatLng(51.532470, -0.470264)).title("Kilmorey Hall").snippet(""));
        ...
        Marker Faraday3 = mMap.addMarker(new MarkerOptions().position(new LatLng(51.531740, -0.470399)).title("Faraday Complex").snippet(""));
        ...
        Marker Wolfson = mMap.addMarker(new MarkerOptions().position(new LatLng(51.534211, -0.472475)).title("Wolfson Centre").snippet("Materials Processing").snippet("Specialist Research Institute that focuses on materials science."));
        Marker Bragg = mMap.addMarker(new MarkerOptions().position(new LatLng(51.534525, -0.473025)).title("Bragg").snippet("Experimental Quality Testing Building"));
        Marker Halsbury = mMap.addMarker(new MarkerOptions().position(new LatLng(51.533824, -0.472735)).title("Halsbury").snippet("Center for Computer Science").snippet("Named in memory of The 3rd Earl of Halsbury"));
        ...
        Marker Heinz = mMap.addMarker(new MarkerOptions().position(new LatLng(51.534057, -0.474752)).title("Heinz Wolff").snippet("The Brunel Institute for Bioengineering"));
        Marker John = mMap.addMarker(new MarkerOptions().position(new LatLng(51.533443, -0.472016)).title("John Crank").snippet("The Brunel Institute for Mathmatics").snippet("Named in memory of John Crank"));
        ...
        Marker Hamilton = mMap.addMarker(new MarkerOptions().position(new LatLng(51.533310, -0.473909)).title("The Hamilton Centre").snippet("Home of the Academy, Social Kitchen, Yardbird, and LOCOS").snippet("Named in memory of Eric Hamilton"));
        ...
        Marker Banneram = mMap.addMarker(new MarkerOptions().position(new LatLng(51.532747, -0.473625)).title("Bannerman Centre").snippet("Home of the Library, Costa and Student Center").snippet("Named in memory of Sheila Bannerman"));
        Marker Sterling = mMap.addMarker(new MarkerOptions().position(new LatLng(51.532933, -0.474790)).title("Micheal Sterling").snippet("Engineering and Design building"));
        Marker Brown = mMap.addMarker(new MarkerOptions().position(new LatLng(51.532900, -0.475338)).title("Wilfred Brown").snippet("Currenly Under Construction").snippet("Named in memory of Wilfred Brown"));
        Marker HQ = mMap.addMarker(new MarkerOptions().position(new LatLng(51.532500, -0.474740)).title("Security HQ"));
        ...
        Marker Ta = mMap.addMarker(new MarkerOptions().position(new LatLng(51.532207, -0.474161)).title("Tower A").snippet("Graphics design and Media"));
        Marker Tb = mMap.addMarker(new MarkerOptions().position(new LatLng(51.531488, -0.474266)).title("Tower B").snippet("Graphics design and Media"));
        Marker Tc = mMap.addMarker(new MarkerOptions().position(new LatLng(51.531328, -0.473526)).title("Tower C").snippet("Graphics design and Media"));
        Marker td = mMap.addMarker(new MarkerOptions().position(new LatLng(51.531345, -0.472829)).title("Tower D").snippet("Graphics design and Media"));
        Marker Howell = mMap.addMarker(new MarkerOptions().position(new LatLng(51.531952, -0.473237)).title("Howell").snippet("Electrical Engineering and Lecture Hall").snippet("Named in memory of Robin Howell"));
        Marker JL = mMap.addMarker(new MarkerOptions().position(new LatLng(51.530881, -0.474032)).title("Joseph Lowe").snippet("School of Mechanical Engineering").snippet("Named in memory of Joseph Lowe"));
        Marker AA = mMap.addMarker(new MarkerOptions().position(new LatLng(51.530958, -0.474966)).title("Antonin Artaud").snippet("Arts performance space for Theatre and Music, as well as the home of Journalism, Film and TV.").snippet("Named in memory of Antonin Artaud"));
        ...
        Marker MJ = mMap.addMarker(new MarkerOptions().position(new LatLng(51.532955, -0.476642)).title("Marie Jahoda").snippet("Department of Psychology").snippet("Named in memory of Marie Jahoda"));
        Marker MT = mMap.addMarker(new MarkerOptions().position(new LatLng(51.532985, -0.477315)).title("Meeting House").snippet(""));
        Marker Gaskell = mMap.addMarker(new MarkerOptions().position(new LatLng(51.533002, -0.478173)).title("Gaskell").snippet("School of Arts").snippet("Named in memory of Elizabeth Gaskell"));
        Marker Chadwick = mMap.addMarker(new MarkerOptions().position(new LatLng(51.532702, -0.478838)).title("Chadwick").snippet("School of Physics").snippet("Named i memory of James Chadwick"));
